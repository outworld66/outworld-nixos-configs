...
{
  # The shell's apply-chrome-theme.sh writes a BrowserThemeColor policy file into
  ...
  # sudo after every theme pipeline run (every NixOS switch restarts the shell and
